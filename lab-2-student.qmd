...
str(surveys)
```
record_id, month, day, year, plot_id, hindfoot_length, and weight are all numeric
species_id, sex, day_of_week, plot_type, genus, species, and taxa are all characters
date is a date type variable

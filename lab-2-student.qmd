...
ggplot(data = surveys,
  ...
  facet_wrap(~ species) + 
  labs(title = "Weight of a Rodent Compared to its Hindfoot Length by Species", x = "Weight (g)", y = NULL, subtitle = "Hindfoot Length (mm)")
```
...
ggplot(data = surveys,
  ...
  geom_boxplot(fill = "red3", outliers = FALSE)
